...
The B100 plugin is split into two Python modules. The b100 module 
...
b100modus module splits out the Modbus communcations code to make the 
code more modular and easier to maintain and understand.

This b100 module calls get_b100_readings in the b100modbus module to
get the readings from the B100.
